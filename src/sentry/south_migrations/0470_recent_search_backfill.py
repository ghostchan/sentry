...
db_query = """
-- Make sure that we only fetch up to 30 searches per user, and filter out any
-- that already exist
SELECT organization_id, user_id, 0 as "type", query, date_added
FROM (
    SELECT user_id, query, organization_id, date_added, rank() OVER (PARTITION BY user_id ORDER BY date_added DESC) AS pos
    FROM (
        -- Group together all saved searches and deduplicate
        SELECT user_id, query, organization_id, max(date_added) date_added
        FROM (
            (
                -- Get all saved searches that the user explicitly set as default
                SELECT user_id, query, sp.organization_id, max(ss.date_added) AS date_added
                FROM sentry_savedsearch_userdefault ssud
                INNER JOIN sentry_savedsearch ss ON ss.id = ssud.savedsearch_id
                INNER JOIN sentry_project sp on sp.id = ssud.project_id
                WHERE ss.query NOT IN ('is:unresolved',
                                  'is:unresolved is:unassigned',
                                  'is:unresolved assigned:me',
                                  'is:unresolved bookmarks:me',
                                  'is:unresolved age:-24h')
                GROUP BY user_id, query, sp.organization_id
            )
            UNION (
                -- Also get saved searches that are part of projects they work on
                SELECT om.user_id, ss.query, sp.organization_id, max(ss.date_added) AS date_added
                FROM sentry_savedsearch ss
                INNER JOIN sentry_project sp on sp.id = ss.project_id
                INNER JOIN sentry_projectteam pt ON pt.project_id = ss.project_id
                INNER JOIN sentry_organizationmember_teams omt ON omt.team_id = pt.team_id
                INNER JOIN sentry_organizationmember om ON om.id = omt.organizationmember_id
                WHERE ss.query NOT IN ('is:unresolved',
                                  'is:unresolved is:unassigned',
                                  'is:unresolved assigned:me',
                                  'is:unresolved bookmarks:me',
                                  'is:unresolved age:-24h')
                GROUP BY om.user_id, ss.query, sp.organization_id
            )
        ) recent_searches
        WHERE user_id IS NOT NULL
        GROUP BY user_id, query, organization_id
    ) recent_searches
) AS recent_searches
WHERE pos <= 30
and not exists (
    select *
    from sentry_recentsearch rs
    where rs.organization_id = recent_searches.organization_id
    and rs.user_id = recent_searches.user_id
    and rs."type" = 0
    and rs.query = recent_searches.query
)
"""
...
class Migration(DataMigration):
    ...
    def _forwards(self, orm):
        ...
        RecentSearch = orm['sentry.RecentSearch']
        cursor = connection.cursor()
        cursor.execute(db_query)
        recent_searches = cursor.fetchall()
        # This query will return ~80k rows. Should be fine to just load them all
        # into memory and create serially.

        # Note that since we're already creating recent searches we might go over
        # the 30 recent searches per user limit. I'll audit this afterwards and
        # if we see it happen a lot will write something to clean it up. But for
        # the most part we probably won't see this a lot, and active users will
        # trigger a cleanup each time they do another search.
        for organization_id, user_id, search_type, query, date_added in WithProgressBar(
            recent_searches,
        ):
            date_added = min(date_added, datetime.datetime(2019, 03, 18))
            try:
                RecentSearch.objects.get_or_create(
                    organization_id=organization_id,
                    user_id=user_id,
                    type=search_type,
                    query=query,
                    query_hash=md5_text(query).hexdigest(),
                    defaults={'date_added': date_added, 'last_seen': date_added},
                )
            except Exception:
                logging.exception(
    ...
    def backwards(self, orm):
        ...
        RecentSearch = orm['sentry.RecentSearch']
        # Anything created before this date is just data from the backfill, so
        # we can just remove
        RecentSearch.objects.filter(date_added__lt=datetime.datetime(2019, 03, 19)).delete()
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'97603a7c1b434ab88f0358eda541f58496bea5ecca4e49f0aae09368ea51fc83'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'a8766660d3f346f9b5d914bf46ed75562281272310a24c59a4f2dadd954f00bd'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Clear Foxhound'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'062b71c25df945e9a0ae522cbaa21a47'", 'max_length': '64', 'db_index': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 3, 25, 0, 0)', 'db_index': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'application': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.ApiApplication']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 24, 0, 0)', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'22f704cad36c47be8639f92209b334c6bfe9fcd5210c49979398b5746e0120bc'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'c22d3f2aac374c5da686983244c5ee238f877392d266445284d35e15992576d8'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a9a592d389e540c880b1a6915391304c'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_scheduled': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 24, 0, 0)'}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'21ece33e915e48a6a0d20a5b906879ab'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fcecde96-7eea-4e47-88d1-f2486e083e14'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6f60ba16-c66c-4f9d-b9b1-05594a7421dc'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'d7eadd5dfc524ffea8c12097ec858e98a2b36f1db4f7461da97dbc5286163d56'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'RdypV0M117QuHNrqh61cJLXc1UXgWUJR'", 'max_length': '32'})
        },
        'sentry.userip': {
